function EPICS = EXTRACT_EPICS(d,n_step,DAQ_info,isscan)
...
for i=1:n_step
    ...
    end_ind = shots(i+1);
    if isscan
        EPICS.scan_val((start_ind+1):end_ind) = DAQ_info.scan_info(i).Control_PV;
    else
        EPICS.scan_val((start_ind+1):end_ind) = 0;
    end
